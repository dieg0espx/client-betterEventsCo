          ...
          : 
            ...
            .concat(
              extras
                ...
                .map((extra) => (
                  <div className="inflatable" key={extra.id} style={{display: currentCategory == 'extras' && extra.name.toLowerCase().includes('package') || currentCategory == 'extras' &&  extra.name.toLowerCase().includes('pkg')  ? "none":"block"}}>
                    <img src={extra.image} alt={extra.name} />
                    <div id="name-price">
                      <p id="name">{extra.name}</p>
                      <p id="price" style={{display: extra.name.toLowerCase().includes('wedding') ? "none" : "block"}}>${extra.price}</p>
